...
- Loading: the map's own vessel sprite sketched on stroke by stroke - hull,
  cabin, windows, stack, wake - then filled in the mode tokens, looping until
  the map is up (`LoadingFerry`, 2026-09-01). "Talking to the Sound..." stays
  as its accessible name; reduced-motion users get the finished boat, still.
